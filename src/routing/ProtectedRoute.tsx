...
import LitButtonReact from "@mf-app/remote/web-components/lit-button";

function ProtectedRoute<
  T extends DefaultParams | undefined = undefined,
  RoutePath extends string = string
>(props: RouteProps<T, RoutePath>): ReturnType<FunctionComponent> {
  const { isAuthenticated, actions, loading } = useAuthStore();
    ...
    <div>
      <nav className="bg-white dark:bg-gray-900 sticky w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <h1 className="text-2xl font-semibold whitespace-nowrap dark:text-white">MF Host App</h1>
